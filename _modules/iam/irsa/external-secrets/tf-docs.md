...
| Name | Type |
|------|------|
| [aws_iam_policy.irsa-external_secrets](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
...
| [aws_iam_policy_document.external_secrets-policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| <a name="input_k8s_service_account_name"></a> [k8s\_service\_account\_name](#input\_k8s\_service\_account\_name) | Kubernetes service account name for IRSA. | `string` | `"external-secrets-sa"` | no |
...
| <a name="input_target_secretsmanager"></a> [target\_secretsmanager](#input\_target\_secretsmanager) | Secretmanager arn list that external secrets can access. Default value is "arn:aws:secretsmanager:$\{data.aws\_region.current.name\}:$\{data.aws\_caller\_identity.current.account\_id\}:*" | `list(string)` | `null` | no |
